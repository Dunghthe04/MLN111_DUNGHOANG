...
export default function Title() {
  ...
  return (
    <div>
      <div className="h-[50rem] bg-[url(/imgs/real/home-hero-1.jpg)] bg-cover">
        <div className="size-full bg-yellow-800/50 grid grid-rows-[1fr_5rem]">
         ...
         text-gray-200 text-center text-7xl font-title px-80">
            <h2 className={clsx("drop-shadow-lg drop-shadow-black", !loaded ? "animate-fallDown" : "hover:animate-wiggle")}>TRIẾT HỌC MÁC-LÊNIN</h2>
            <p className={clsx("drop-shadow-lg drop-shadow-black font-sans", !loaded ? "animate-slideLeft" : "hover:animate-wiggle")}>-</p>
            <h2 className={clsx("drop-shadow-lg drop-shadow-black", !loaded ? "animate-slideRight" : "hover:animate-wiggle")}>Cẩm nang học tập và suy ngẫm</h2>
